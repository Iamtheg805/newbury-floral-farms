...
async function findOrCreateCustomer(accessToken: string, realmId: string, customerName: string, ccEmail: string, bccEmail: string) {
  ...
  for (const order of orders) {
    ...
    for (const item of orderItems) {
      ...
      if (itemIdCache[name] === undefined) {
        itemIdCache[name] = await findOrCreateItem(qbTokens.access_token, qbTokens.realm_id, name)
      }
